...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/pi/easyNav-gears/CG3002_ROS_WS/install/${idir})
      set(include /home/pi/easyNav-gears/CG3002_ROS_WS/install/${idir})
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/easyNav-gears/CG3002_ROS_WS/install/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/easyNav-gears/CG3002_ROS_WS/install/lib;/home/pi/easyNav-gears/CG3002_ROS_WS/devel/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/groovy/lib)
